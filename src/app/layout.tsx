...
export const metadata: Metadata = {
  ...
  description:
    "Full Stack Software Engineer with 3+ years of experience. Specializing in Angular, React, .NET Core, and Microsoft Azure. Microsoft Certified AI & Cloud professional based in Vadodara, India.",
  keywords: [
    "Krenil Patel",
    "Full Stack Engineer",
    "React",
