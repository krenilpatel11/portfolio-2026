      ...
      <div className="relative">
        ...
        >
          {doubled.map((t, i) => (
            <div
              key={i}
              className="w-[380px] shrink-0 bg-[var(--card-bg)] border border-[var(--border)] rounded-2xl p-6 shadow-sm"
            >
              {/* Quote mark */}
              <div className="text-5xl font-serif text-[var(--accent)] leading-none mb-3">&ldquo;</div>
              <p className="text-sm text-[var(--foreground)] leading-relaxed mb-5 line-clamp-4">{t.quote}</p>
